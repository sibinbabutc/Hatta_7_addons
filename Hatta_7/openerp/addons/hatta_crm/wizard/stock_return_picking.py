...
#         new_pick_name = self.pool.get('ir.sequence').get(cr, uid, seq_obj_name)
        parent_picking_type = pick.type
        cost_center_id = pick.cost_center_id and pick.cost_center_id.id or False
        if parent_picking_type == 'out':
            model = 'stock.picking.out'
        elif parent_picking_type == 'in':
            model = 'stock.picking.in'
        else:
            model = 'stock.picking'
        transaction_type_ids = transaction_type_pool.search(cr, uid, [('model_id.model', '=', model),
                                                                      ('refund', '=', True),
