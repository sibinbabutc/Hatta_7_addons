...
class upcoming_payable_report(JasperDataParser.JasperDataParser):
    def __init__(self, cr, uid, ids, data, context):
        super(upcoming_payable_report, self).__init__(cr, uid, ids, data, context)
    ...
    def generate_parameters(self, cr, uid, ids, data, context=None):
        ...
        report_heading = "Upcoming Payable Report (%s - %s)"%(from_date,to_date)
        vals = {
...
jasper_report.report_jasper('report.upcoming_payable_report.jasper', 'wizard.upcoming.payable', parser=upcoming_payable_report)
